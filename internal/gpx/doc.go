/*
Package gpx parses GPX 1.1 files into an in-memory track model. Parsing relies
on encoding/xml only.
...
its epsilon in screen pixels at the chosen zoom. Both make it a consumer of
the Mercator projection rather than of the GPX model. This package therefore
